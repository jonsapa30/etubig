...
{
mysqli_query($conn,"insert into wishlist(userId,productId) values('".$_SESSION['id']."','".$_GET['pid']."')");
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        ...
        <ul class="nav">
            <li class="dropdown menu-item">
              <?php $sql=mysqli_query($conn,"select id,subcategory  from subcategory where categoryid='$cid'");
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($conn,"select * from products where category='$cid'");
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price" style="color:black;">
					₱ <?php echo htmlentities($row['productPrice']);?>.00			</span>
