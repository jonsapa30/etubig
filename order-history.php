...
<?php $query=mysqli_query($conn,"select products.productImage1 as pimg1,products.productName as pname,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice, products.productPriceBeforeDiscount as pdis,products.shippingCharge as shippingcharge,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid, orders.type as otype from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null ORDER BY odate DESC");
$cnt=1;
...
?>
				<tr>
					...
					<?php if($row['otype'] == '1'):?>
					<td class="cart-product-sub-total"><?php echo $price=$row['pdis']; ?>  </td>
					<?php else:?>
					...
					<?php if($row['otype'] == '1'):?>
					<td class="cart-product-sub-total">Exchange Bottle </td>
					<?php else:?>
						<td class="cart-product-sub-total">New Bottle </td>
					<?php endif;?>
					<td>
