...
<!-- ================================== TOP NAVIGATION : END ================================== -->
			...
			<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
				<!-- ========================================== SECTION – HERO ========================================= -->
		<h2 style="text-align: center; color:#008BED;">Thirsty? Good We are here to serve you!</h2>	
		<br>
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/cover.jpg);" width="1050" height="300">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
...
?>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price" style="color:grey;">
					New Bottle: ₱<?php echo htmlentities($row['productPrice']);?>.00		
					<br>
					Exchange Bottle: ₱<?php echo htmlentities($row['productPriceBeforeDiscount']);?>.00	</span>
	...
	<div class="tab-pane" id="books">
		...
		<?php
$ret=mysqli_query($conn,"select * from products where category=3");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
	...
	<?php } ?>
		...
		<div class="tab-pane" id="furniture">
					<div class="product-slider">
						<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
		<?php
$ret=mysqli_query($conn,"select * from products where category=5");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php
$ret=mysqli_query($conn,"select * from products where category=4 and subCategory=4");
while ($row=mysqli_fetch_array($ret)) 
{
?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title"></h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($conn,"select * from products where category=4 and subCategory=6");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		...
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysqli_query($conn,"select * from products where category=6");
while ($row=mysqli_fetch_array($ret)) 
{
	# code...
