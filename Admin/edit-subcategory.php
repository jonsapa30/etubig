...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = intval($_GET['id']);
        $sql = mysqli_prepare($conn, "UPDATE subcategory SET categoryid=?, subcategory=?, updationDate=? WHERE id=?");
        mysqli_stmt_bind_param($sql, 'issi', $category, $subcat, $currentTime, $id);
