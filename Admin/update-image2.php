...
$ret=mysqli_query($conn,"select productImage2 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysqli_query($conn,"update  products set productImage2='$productimage2' where id='$pid' ");
...
$query=mysqli_query($conn,"select productName,productImage2 from products where id='$pid'");
$cnt=1;
