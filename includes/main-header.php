				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">₱.<?php echo (($row['productPrice'] * $_SESSION['cart'][$row['id']]['quantity']) +($row['shippingCharge'] * $_SESSION['cart'][$row['id']]['quantity']));?>.00</div>
						</div>
		...
		<a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
			<div class="items-cart-inner">
				<div class="total-price-basket">
					<span class="lbl">cart -</span>
					<span class="total-price">
						<span class="sign" style="color:black;">₱</span>
						<span class="value" style="color:black;">00.00</span>
					</span>
				</div>
				<div class="basket">
					<i class="glyphicon glyphicon-shopping-cart" style="color:black;"></i>
				</div>
				<div class="basket-item-count"><span class="count" style="color:black;">0</span></div>
